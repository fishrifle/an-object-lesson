...
// const isAnExcellentObject = true;
...
// let newObjectTerm = isAnExcellentObject + 1;
// console.log(newObjectTerm, isAnExcellentObject
...
myOwnObject.firstName = "Jesse"
console.log(myOwnObject)

// Add a `lastName` property and set it to a string.
myOwnObject.lastName = "Davis"
console.log(myOwnObject)
...
myOwnObject["address"] = ["9675", "Sparta", "Hwy"];
console.log(myOwnObject)
